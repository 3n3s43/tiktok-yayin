import eventlet
# DİKKAT: RLock hatasını çözmek için 'all=True' şarttır!
...
async def on_gift(event: GiftEvent):
    ...
    print(f"Hediye: {event.gift.name} | Gönderen: {event.user.unique_id}")

# TikTok dinleyicisini arka planda güvenli çalıştırma
def start_tiktok():
    try:
        print("TikTok Canlı Yayın Dinleyicisi Başlatılıyor...")
        client.run()
...
if __name__ == '__main__':
    # Render için portu dışarıdan alıyoruz
